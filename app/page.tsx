...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 ">
      ...
      <div className="w-full h-min md:h-[500px] flex flex-col md:flex-row items-center md:justify-center px-6 md:px-20 mt-4 md:mt-0  ">
...
{/* RIGHT SIDE - Cube */}
<div className="relative w-full md:w-[50%] h-[150px] md:h-full flex md:pl-[50px] md:items-center  bg-gray-50 ">
