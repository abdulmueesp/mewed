  ...
  Asked Questions
          ...
          <div className="space-y-4 ">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className=" rounded-lg bg-white shadow-lg transition-shadow hover:shadow-md"
              >
                <button
        ...
        >
          <img
            ...
            className="w-72 md:w-80 lg:w-[370px] object-contain md:absolute md:top-12 md:right-0 border-b-2 border-gray-400 "
